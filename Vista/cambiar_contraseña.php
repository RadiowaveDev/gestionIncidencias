                ...
                <div class="container-fluid">
                    <div class="text-center">
                        <h2 class="text-gray-900 mb-4">
                            Conoce tu nuevo portal del estudiante.
                        </h2>
                    </div>
                    <div class="text-justify">
                        <p>
                            Puedes hacer todo lo que necesitas para llevar tu vida
                            universitaria. Revisa tus horarios, eventos, trámites y
                            más. De manera más fácil y sencilla.
                        </p>
                    </div>
                    <div>
                    ...
                    <form method="POST" action="../CONTROLADOR/validar_login.php">
                        <div class="form-group">
                            <input type="email" class="form-control form-control-user" id="exampleInputEmail" name="correo" aria-describedby="emailHelp" placeholder="Correo Electrónico" />
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control form-control-user" id="exampleInputPassword" name="contraseña" placeholder="Contraseña" />
                        </div>
                        <div class="form-group">
                        </div>
                        <hr />
